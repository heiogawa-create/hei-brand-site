...
function AppRoutes(){return(<Layout><ScrollToTop/><Routes><Route path="/" element={<Home/>}/><Route path="/health" element={<HealthBlog/>}/><Route path="/ai" element={<AIBlog/>}/><Route path="/mogukuma" element={<Mogukuma/>}/><Route path="/resources" element={<Resources/>}/><Route path="/about" element={<About/>}/><Route path="/contact" element={<Contact/>}/><Route path="*" element={<NotFound/>}/></Routes></Layout>)}
