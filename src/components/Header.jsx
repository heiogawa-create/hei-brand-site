...
import'./Header.css'
const NAV=[{to:'/health',label:'健康・栄養'},{to:'/ai',label:'ダイエット豆知識'},{to:'/mogukuma',label:'モグクマ'},{to:'/resources',label:'おすすめAI教材'},{to:'/about',label:'プロフィール'}]
