...
import'./Header.css'
const NAV=[{to:'/',label:'ホーム'},{to:'/health',label:'健康・栄養'},{to:'/ai',label:'ダイエット豆知識'},{to:'/mogukuma',label:'モグクマ'},{to:'/resources',label:'おすすめ教材'},{to:'/apps',label:'アプリ一覧'},{to:'/about',label:'プロフィール'}]
