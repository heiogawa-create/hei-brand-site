...
export default function HealthBlog(){
  return(
    <div className="blog-page">
      ...
      {/* ヒーロー：料理写真を背景に */}
      <div className="blog-page__hero" style={{backgroundImage:"url('/health_hero.png')"}}>
        <div className="container">
          <div className="blog-page__label">Health & Nutrition</div>
          <h1 className="blog-page__title">健康・栄養ブログ</h1>
      ...
      <div className="container">
        ...
        <div className="blog-banner">
          <img src="/health_banner.png" alt="健康的な読書" />
        </div>
        ...
        <div className="blog-page__note-cta">
          <p>有料詳細版はnoteで公開中</p>
          <a href="https://note.com/" target="_blank" rel="noopener">noteで読む →</a>
        </div>
      </div>
    </div>
  )
